...
{
    System.out.println("*******************");
    System.out.println("Calculate Dividend Yield for  stock with given market price \n");
    ...
    for (IStock stock:stockManager.GetStocks())
    {
        try {
            ...
            System.out.println("Dividend Yield for " + stock.GetStockSymbol() +  " is: " + dividendYield);
        }
    ...
    private static void PERatioDemo()
{
    ...
    for (IStock stock:stockManager.GetStocks())
    {
        try {
            ...
            System.out.println("PE Ratio for " + stock.GetStockSymbol() +  " is: " + peRatio);
        }
        catch (StockTypeNotFoundException e) {
            System.out.println(e.getMessage());
        }
